  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <div class="sidebar-menu">
        <ul>
          <li>
            <a href="adminhome.php" class="active" style="text-decoration: none"><span class="las la-igloo"></span>
            <span>Home</span></a>
          </li>
          <li>
            <a href="" style="text-decoration: none"><span class="las la-users"></span>
          ...
          <li>
            <a href="" style="text-decoration: none"><i class="fa-solid fa-user-plus"></i>
