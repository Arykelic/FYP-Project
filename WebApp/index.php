...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($username_err) && empty($password_err)) {
    ...
    $sql = "SELECT userid, username, password, firstname, lastname, phonenumber, emailaddress, BirthDate, Gender, usertype, accountstatus FROM user WHERE username = ?";
          ...
          if ($stmt->fetch()) {
            ...
            if (password_verify($password, $passwordtest)) {
              ...
              if ($_SESSION['accountstatus'] === 'Active') {
                // Account status is active, so login to system         
    ...
    <div class="row px-3">
      <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0">
        ...
        <div class="card-body">
          ...
          <h4 class="title text-center mt-4">
            <img class="logo" src="elogo.jpg"></img>E-Commerce Insight
          </h4>
